...
if options.outputFile == "":
    outputFile = "file:hbanalysis_{}.root".format(options.run)
...
process = cms.Process('HBAnalysis',eras.Run2_2018)
...
process.load("Analysis.HBPhaseOne.HBAnalysis_cfi")
...
process.GlobalTag.globaltag = '105X_postLS2_realistic_v6'
